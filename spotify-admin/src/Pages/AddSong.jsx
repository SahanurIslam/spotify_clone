...
const AddSong = () => {
    ...
    const onSubmitHandler = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(`${url}/api/song/create_song`, formData);
        ...
        <form onSubmit={onSubmitHandler} className='flex flex-col items-start gap-8 text-gray-600 '>
            <div className='flex gap-8'>
                <div className='flex flex-col gap-4'>
                    <p>Upload Song</p>
                    <input type="file" id="song" accept='audio/*' hidden onChange={(e) => { setSong(e.target.files[0]) }} />
                    <label htmlFor="song">
            ...
            <div className='flex flex-col gap-2.5'>
                <p>Album</p>
                <select onChange={(e) => { setAlbum(e.target.value) }} defaultValue={album} className='bg-transparent outline-green-600 border-2  border-gray-400 p-2.5 w-[max(150px)] ' name="" id="">
